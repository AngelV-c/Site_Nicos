...
const translations = {
  ...
  pt: {
    ...
    'strip.hours':   'Sex · Sáb · Dom · 10h às 22h  |  Seg · Ter · Qui · 10h às 17h',
    ...
    'sobre.since':   'Desde',
    'sobre.p1':      'Desde 1984, o Nico\'s é ponto de encontro da família Vilani e dos apaixonados pela boa mesa em Mariscal, Bombinhas. Nascemos à beira-mar e crescemos com o mesmo propósito: servir frutos do mar fresquíssimos, carnes selecionadas, massas artesanais e as famosas pizzas no forno à lenha.',
    'sobre.p2':      'Num mesmo espaço acolhedor, funcionamos de dia como Restaurante à La Carte, com o melhor dos frutos do mar em pratos para dividir, e à noite como Pizzaria, com nossas famosas pizzas no forno à lenha para toda a família. O cuidado com o ingrediente e o calor do atendimento são a nossa marca registrada há mais de quatro décadas.',
    'sobre.p3':      'E para completar a experiência, oferecemos como cortesia mais de 100 tipos de cachaças artesanais, produzidas com ervas e ingredientes naturais, o brinde perfeito para encerrar uma boa refeição à beira-mar.',
  ...
  en: {
    ...
    /* Info strip */
    'strip.address': 'Av. Água Marinha, 1204, Mariscal, Bombinhas/SC',
    'strip.hours':   'Fri · Sat · Sun · 10am to 10pm  |  Mon · Tue · Thu · 10am to 5pm',
    ...
    'sobre.since':   'Since',
    'sobre.p1':      'Since 1984, Nico\'s has been a gathering place for the Vilani family and lovers of good food in Mariscal, Bombinhas. We were born by the sea and grew with the same purpose: to serve the freshest seafood, selected meats, homemade pasta, and our famous wood-fired pizzas.',
    'sobre.p2':      'In a welcoming space, we operate during the day as an À La Carte Restaurant, with the best seafood dishes to share, and at night as a Pizzeria, with our famous wood-fired pizzas for the whole family. Our dedication to quality ingredients and warm service have been our hallmark for over four decades.',
    'sobre.p3':      'And to complete the experience, we offer as a courtesy over 100 types of artisanal cachaças, made with herbs and natural ingredients, the perfect toast to end a great meal by the sea.',
    'sobre.h1':      'Menu items',
  ...
  es: {
    ...
    /* Info strip */
    'strip.address': 'Av. Água Marinha, 1204, Mariscal, Bombinhas/SC',
    'strip.hours':   'Vie · Sáb · Dom · 10h a 22h  |  Lun · Mar · Jue · 10h a 17h',
    ...
    'sobre.since':   'Desde',
    'sobre.p1':      'Desde 1984, el Nico\'s es punto de encuentro de la familia Vilani y de los amantes de la buena mesa en Mariscal, Bombinhas. Nacimos junto al mar y crecimos con el mismo propósito: servir mariscos fresquísimos, carnes seleccionadas, pastas artesanales y las famosas pizzas al horno de leña.',
    'sobre.p2':      'En un acogedor espacio, funcionamos de día como Restaurante à La Carte, con lo mejor de los mariscos en platos para compartir, y de noche como Pizzería, con nuestras famosas pizzas al horno de leña para toda la familia. El cuidado por el ingrediente y la calidez en la atención son nuestra marca registrada desde hace más de cuatro décadas.',
    'sobre.p3':      'Y para completar la experiencia, ofrecemos como cortesía más de 100 tipos de cachaças artesanales, elaboradas con hierbas e ingredientes naturales, el brindis perfecto para cerrar una buena comida junto al mar.',
